                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'code'">{{ trans('admin.service.columns.code') }}</th>
                                    <th is='sortable' :column="'data'">{{ trans('admin.service.columns.data') }}</th>
                                    <th is='sortable' :column="'name'">{{ trans('admin.service.columns.name') }}</th>
                                    <th is='sortable' :column="'status'">{{ trans('admin.service.columns.status') }}</th>
